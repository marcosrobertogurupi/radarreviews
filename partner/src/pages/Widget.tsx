...
import { Copy, RefreshCw, Eye, Code, Palette, Save, Loader2, ShieldCheck, Sparkles, Check } from 'lucide-react'
...
export default function Widget({ tenantId }: Props) {
  ...
  async function handleRotateToken() {
    if (!confirm('Deseja realmente gerar um novo token de segurança? O código antigo deixará de carregar até ser atualizado.')) {
      return
    }
    setRotating(true)
    try {
