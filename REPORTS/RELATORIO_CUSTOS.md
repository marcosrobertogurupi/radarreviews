...
| Serviço | Finalidade | Modelo de Cobrança | Custo Estimado (Mensal) |
| :--- | :--- | :--- | :--- |
| **Google Gemini API** | Análise de Sentimento e Suporte IA (Flash + Embeddings) | Pay-as-you-go | **$1.00 - $5.00** (Alta eficiência/Baixo custo) |
...
*   **Gemini 1.5 Flash & Embeddings:** Escolhemos este modelo para análise de sentimento e o novo sistema de suporte devido ao seu custo imbatível e suporte nativo a vetores (`gemini-embedding-001`).
*   **Claude 3 Haiku:** Implementado no Copiloto para garantir respostas mais naturais e empáticas que o Gemini.
*   **Suporte Multi-tenant:** O isolamento de anexos via Supabase Storage e RLS permite escalar o suporte sem aumentar complexidade de custo fixo.
